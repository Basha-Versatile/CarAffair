...
export default function DashboardPage() {
  const { jobCards, isLoading: jobsLoading } = useAppSelector((state) => state.jobCards);
        ...
        <div className="lg:col-span-2">
          <Card>
            <div className="flex items-center justify-between mb-6">
              ...
              <a href="/admin/job-cards" className="text-sm text-red-500 hover:text-red-400 flex items-center gap-1 transition-colors">
